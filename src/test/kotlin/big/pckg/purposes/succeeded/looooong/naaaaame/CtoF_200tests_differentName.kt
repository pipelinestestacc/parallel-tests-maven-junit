...
/**
 * Same as CelsiusToFahrenheitTest_200tests, but with different name.
 */
class CtoF_200tests_differentName {

    @ParameterizedTest(name = "celsius to fahrenheit with different name [{index}]")
    @MethodSource("cToFDataProvider")
    fun `celsius to fahrenheit with different name`(testCase: DoubleArray) {
    ...
    companion object {
        @JvmStatic
        fun cToFDataProvider(): Stream<DoubleArray> {
